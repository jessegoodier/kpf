...
class TestServiceSelector:
    ...
    def test_prompt_for_local_port_unavailable(self, mock_prompt, service_selector):
        ...
        with patch.object(service_selector, '_is_port_available', return_value=False), \
    ...
    def test_prompt_for_local_port_custom_unavailable(self, mock_prompt, service_selector):
        ...
        with patch.object(service_selector, '_is_port_available', side_effect=mock_port_available), \
    ...
    def test_check_kubectl_failed(self, mock_k8s_client):
        ...
        with patch('subprocess.run') as mock_run:
            ...
            mock_run.return_value.stderr = b"Connection refused"
...
class TestServiceSelectorIntegration:
    ...
    def test_select_service_in_namespace_no_resources(self, mock_k8s_client):
        """Test select_service_in_namespace when no resources found."""
        mock_k8s_client.get_services_in_namespace.return_value = []
        mock_k8s_client.get_pods_with_ports.return_value = []
        mock_k8s_client.get_deployments_with_ports.return_value = []
        ...
        no_resources_calls = [call for call in mock_print.call_args_list 
                             if 'No resources found' in str(call)]
