...
class TestArgumentParser:
    ...
    def test_parser_legacy_args(self):
        ...
        assert args.args == ["svc/frontend", "8080:8080", "-n", "production"]
        assert args.prompt is False
        assert args.all is False
...
class TestHandlePromptMode:
    ...
    def test_handle_prompt_mode_namespace(self, mock_selector_class, mock_client_class):
        ...
        mock_selector.select_service_in_namespace.return_value = ["svc/test", "8080:8080", "-n", "test"]
    ...
    def test_handle_prompt_mode_all_namespaces(self, mock_selector_class, mock_client_class):
        ...
        mock_client_class.return_value = mock_client
        mock_selector_class.return_value = mock_selector
        mock_selector.select_service_all_namespaces.return_value = ["svc/test", "8080:8080", "-n", "default"]
...
class TestMainFunction:
    ...
    def test_main_prompt_mode(self, mock_run_pf, mock_handle_prompt):
        ...
        mock_run_pf.assert_called_once_with(["svc/test", "8080:8080", "-n", "default"], debug_mode=False)
    ...
    def test_main_prompt_mode_with_debug(self, mock_run_pf, mock_handle_prompt):
        ...
        mock_run_pf.assert_called_once_with(["svc/test", "8080:8080", "-n", "default"], debug_mode=True)
    ...
    def test_main_legacy_mode_with_namespace(self, mock_run_pf):
        ...
        mock_run_pf.assert_called_once_with(["svc/frontend", "8080:8080", "-n", "production"], debug_mode=False)
